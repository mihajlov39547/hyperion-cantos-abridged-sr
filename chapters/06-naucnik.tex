...
Kasnije su se ponovo okupili u salonu.

Niko nije predložio da se vrate.

Niko više nije ni govorio o povratku.

Sol je držao Rejčel.

Hojt je izgledao bolesnije nego ranije.

Silenus je pio u tišini.

Kasad je sedeo blizu oružja.

Bron je gledala prema praznom mestu na kojem je ranije sedeo Mastin.

Konačno je uzdahnula.

``Pretpostavljam da je sada na mene red.''

Konzul je pogledao prema njoj.

Bron je naslonila leđa na zid.

``Moja priča počinje na Lususu.''

Zastala je.

``Jednog dana u moju kancelariju ušao je čovek koji je želeo da istražim njegovo sopstveno ubistvo.''